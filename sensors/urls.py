...
from .views import SensorCreateView, SensorListView, SensorDetailView, SensorDeleteView, SensorUpdateView , SensorObservationListView, SensorObservationDetailView
