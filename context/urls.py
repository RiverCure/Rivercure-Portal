...
from .views import GrantAccess, ContextRequestDecisionView, show_context, download_context, simulation_results, ContextViewSet, UploadContext, EventListView,EventDetailView, ContextSensorListView, ContextListView, ContextDetailView, OtherContextListView, ContextRequestListView
